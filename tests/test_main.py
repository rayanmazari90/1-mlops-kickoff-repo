...
def test_main_pipeline(tmp_path):
    ...
    dummy_data = {
        ...
        'tourney_id': ['2021-01', '2021-02', '2021-03', '2021-04', 
    ...
    dummy_config = {
        ...
        'schema': {
            'required_columns': ['tourney_date', 'surface', 'winner_id', 'winner_seed', 'winner_rank', 'winner_hand', 
                                'winner_ht', 'winner_age', 'loser_id', 'loser_seed', 'loser_rank', 'loser_hand', 
                                'loser_ht', 'loser_age'],
            'allowed_surfaces': ['Hard', 'Clay', 'Grass'],
            'target': 'player_1_win',
            'non_null_columns': ['tourney_date', 'surface', 'winner_id', 'loser_id', 'winner_rank', 'loser_rank']
        },
        'split': {
            'strategy': 'seasons'
        },
        ...
        'evaluation': {
            'metrics': ['accuracy', 'log_loss'], # brier_score needs specific labels sometimes
