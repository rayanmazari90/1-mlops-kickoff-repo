...
| Read-aloud script | [`docs/presentation/SCRIPT_PER_PAGE.md`](docs/presentation/SCRIPT_PER_PAGE.md) | **Teleprompter-style script:** `NARRATOR` + one phrase per line, **PAGE 1–6** = `index.html` → `close.html` |
